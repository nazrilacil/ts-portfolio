...
const socialLinks = [
  {
    name: "GitHub",
    url: "https://github.com/nazrilacil",
    icon: (
  ...
  {
    name: "LinkedIn",
    url: "https://www.linkedin.com/in/nazril-acil",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex gap-4">
              {socialLinks.map((social) => (
                <motion.a
                  ...
                  whileTap={{ scale: 0.9 }}
                  className="p-2 rounded-lg bg-sky-800/10 text-sky-500 hover:bg-sky-500/20 dark:hover:bg-sky-500/30 transition-colors"
                >
                  {social.icon}
                </motion.a>
              ))}
        ...
        <div className="border-t border-gray-800 py-8">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            <p className="text-gray-300 text-sm">
              © {new Date().getFullYear()} Nazril Acil. All rights reserved.
            </p>
          </div>
        </div>
      </div>
